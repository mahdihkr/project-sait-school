...
<head>
    ...
    <title>ورود به کندو | سیستم مدیریت محتوا</title>
            ...
            <div class="bee-hive">
                <div class="bee-card">
                    <div class="bee-header">
                        <h2><i class="fas fa-door-open"></i> ورود به کندو</h2>
                    </div>
                    <div class="bee-body">
                    ...
                    <div class="bee-footer">
                        <p>حساب کاربری ندارید؟ <a href="register.php" class="bee-link">عضویت در کندو</a></p>
                    </div>
                </div>
            </div>
        </div>
